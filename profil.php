  ...
  <?php
    ...
    session_start();
      ...
      if(isset($_SESSION["id_user"])){
        $query_register = $db->prepare("UPDATE user SET mail = :mail, pseudo = :pseudo, nom = :nom, prenom = :prenom, date_naissance = :date_naissance /*profil_pic = :profil_pic*/ WHERE id_user = :id_user");
        if(!filter_var($_GET["mail"], FILTER_VALIDATE_EMAIL)){
            ...
            //$query_register->bindParam(":profil_pic", $_GET["avatar"]);
    ...
    if ($_SESSION["id_user"] == $_GET["id_user"]) {
      ...
      echo '<form action="" method="get" class="stylished-form">
        ...
        <div class="form-display">
          ...
          <input type="text" name="pseudo" id="pseudo" value="' . $prenom . '"
        >
        </div>
        <div class="form-display">
